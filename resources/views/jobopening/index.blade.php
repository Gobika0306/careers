    ...
    <div class="main-card mb-3 card">
      ...
      <div class="table-responsive">
        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
          ...
          <tbody>
            @foreach($jobopening as $jobopening)
           
            <tr>
              <td>{{ $loop->index+1 }}</td>
              <td>{{ $jobopening->Title}}</td>
              <td>{{ $jobopening->Description}}</td>
              <td>{{ $jobopening->Vacancy}}</td>
              <td>{{ $jobopening->Location}}</td>
              <td>{{ $jobopening->Type}}</td>
              <td>{{ $jobopening->departments}}</td>

              <td>
                <a href="jobopening/{{ $jobopening->id }}/edit" class="btn btn-dark btn-sm">Edit</a>
